...
<font size="3"><p style="text-align: center"><b>Tabela 3</b> - Persona Manoel Carvalho Soares</p></font>

| ![Avatar](images/manoel.jpeg) | Figura 3 - Persona Manoel Carvalho Soares <br> Fonte: Elaborado pelo grupo (2024). |
| ----------------------------- | ---------------------------------------------------------------------------------- |
| Nome                          | Manoel Carvalho Soares                                                             |
| Status                        | Persona                                                                            |
| Gênero                        | Masculino                                                                          |
| Idade                         | 63                                                                                 |
| Profissão                     | Servidor público aposentado                                                        |
| Escolaridade                  | Ensino Médio Completo                                                              |
| Habilidades                   | Básico de tecnologia, serviços públicos                                            |
| Experiências                  | Ajuda em serviços com magistrados                                                  |
| Objetivo                      | Conseguir a licença para idoso                                                     |
| Expectativas                  | Facilidade no processo                                                             |
| Requisitos                    | Documentos e dispositivo com acesso à internet                                     |
| Tarefas                       | Logar, criar conta e apresentar documentos                                         |
...
<font size="3"><p style="text-align: center"><b>Tabela 4</b> - Anti-Persona Evelyn Lima Cavalcanti</p></font>

| ![Avatar](https://this-person-does-not-exist.com/img/avatar-gena71cba442f469ba20f4fd244081c79ec.jpg) | Figura 4 - Anti-Persona Evelyn Lima Cavalcanti <br> Fonte: Elaborado pelo grupo (2024). |
| ---------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
...
| ------ | ---------- | ------------------ | ------------------------------------------------------ | ------------------------------------------------------ |
| `1.0`  | 13/05/2024 | Criação da página. | [Vinicius Vieira](https://github.com/viniciusvieira00) | [Filipe Carvalho](https://github.com/filipe-002)       |
| `1.1`  | 13/05/2024 | Ajustes de personas. | [Filipe Carvalho](https://github.com/filipe-002)       | [Vinicius Vieira](https://github.com/viniciusvieira00) |