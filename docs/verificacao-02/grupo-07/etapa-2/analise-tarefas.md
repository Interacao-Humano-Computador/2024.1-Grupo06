# Inspeção da análise de tarefas
...
A tabela 1 a seguir apresenta a checklist referente à Solicitação de Ficha de Atendimento

<center>

**Tabela 1** - Checklist para Agendamento de atendimento presencial.
